...
export function describeAdminRoute(pathname: string, search = ""): AdminRouteDescriptor {
  ...
  if (pathname.startsWith("/admin/competition")) {
    ...
    if (pathname.startsWith("/admin/competition/qualification")) return { ...base, active: "competition", pageTitle: "晋级", pageHint: "竞赛执行 · 晋级确认与正赛名单", eventScoped: true, currentEventId: eventFromQuery, competitionTool: "qualification", loadingKind: "qualification" };
