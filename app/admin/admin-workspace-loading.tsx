...
function RealPageLoading({ pathname, search, viewerRole = "committee" }: { pathname: string; search: string; viewerRole?: string }) {
  ...
  if ((pathname === "/admin" || pathname === "/admin/") && rootSection === "registrations") return <RegistrationsLoadingView />;
  if ((pathname === "/admin" || pathname === "/admin/") && rootSection === "rankings") return <GlobalRankingsLoadingView />;
  ...
  if (pathname.startsWith("/admin/competition/qualification")) return <QualificationLoadingView eventId={eventFromQuery} groupId={groupId} phase={phase} />;
  if (pathname.startsWith("/admin/competition/final-ranking")) return <FinalRankingLoadingView eventId={eventFromQuery} groupId={groupId} />;
