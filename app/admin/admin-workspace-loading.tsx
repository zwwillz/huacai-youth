...
function StructureFirstFrame({ pathname, search, overlay }: { pathname: string; search: string; overlay: boolean }) {
  ...
  else if ((pathname === "/admin/competition" || pathname === "/admin/competition/") && route.loadingKind === "competition") {
    const group = params.get("group") || "u16";
    frame = <CompetitionOverviewView model={makeCompetitionOverviewLoadingModel(params.get("event") || "", group)} />;
  }
